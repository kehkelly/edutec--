document.addEventListener("DOMContentLoaded", () => {
    ...
    const cards = [
        {
            name: 'esqueleto',
            Img: './img/skeleton-rib-cage-color-stroke-by-Vexels.png',
        },
        {
            name: 'celebro',
            Img: './img/pink-human-brain-color-stroke-by-Vexels.png',
        },
        {
            name: 'intestino',
            Img: './img/pink-human-intestines-color-stroke-by-Vexels.png',
        },
        {
            name: 'pulmao',
            Img: './img/lungs-body-organ-color-stroke-by-Vexels.png',
        },
        {
            name: 'coraçao',
            Img: './img/pink-human-heart-color-stroke-by-Vexels.png',
        },
        {
            name: 'utero',
            Img: './img/uterus-body-organ-color-stroke-by-Vexels.png',
        },
        {
            name: 'esqueleto',
            Img: './img/skeleton-rib-cage-color-stroke-by-Vexels.png',
